...
_lr_signature = 'expressionsleftConcatrightPowAlphType And BooleanType CloseStruct Concat Eq False Int IntType KleeneC LGroup LangType LenOp NextLine On OpenStruct Or PositiveC Pow Prefix RGroup Show Splitter String StringType SuchThat Suffix Term True VAlph VBoolean VInt VLang VString VarNameBooleanExpression : BooleanOrAlphExpression : AlphConcatLangExpression : StringPrefix\n    | StringSuffix\n    | AlphKleeneC\n    | AlphPositiveC\n    | LangKleeneC\n    | LangPositiveC\n    | VLangBooleanOr : BooleanAnd Or BooleanAnd\n                | BooleanAndIntExpression : Int\n        | StringLen\n        | VIntStringExpression : StringConcatAlphConcat : AlphConcat Concat AlphPow\n        | AlphPowStringConcat : StringConcat Concat StringPow\n                    | StringPowStringLen : LenOp StringExpression LenOp\n        | LenOp StringExpression On AlphExpression LenOpAlphKleeneC : AlphExpression KleeneC IntExpressionexpressions : expressions expression Term\n                    | expression TermBooleanAnd : BooleanAnd And BooleanAnd\n                    | BooleanGroupAlphPositiveC : AlphExpression PositiveC IntExpressionStringPow : StringPow Pow IntExpression\n                | StringGroup expression : IntExpression\n                    | AlphExpression\n                    | StringExpression\n                    | LangExpression\n                    | ShowVal\n                    | Assigns\n                    | DeclaresAlphPow : AlphPow Pow IntExpression\n            | AlphGroupLangKleeneC : LangExpression KleeneC IntExpressionBooleanGroup : LGroup BooleanExpression RGroup\n                    | Boolean\n                    | VBooleanStringGroup : LGroup StringExpression RGroup\n                    | String\n                    | VStringShowVal : Show expressionLangPositiveC : LangExpression PositiveC IntExpressionAlphGroup : LGroup AlphExpression RGroup\n    | Alph\n    | VAlphStringPrefix : Prefix StringExpressionDeclares : StringDeclare\n        | IntDeclare\n        | AlphDeclare\n        | LangDeclare\n        | BooleanDeclareBoolean : True\n                | FalseAlph : OpenStruct StringList CloseStruct\n            | OpenStruct StringExpression CloseStructStringSuffix : Suffix StringExpressionAssigns : StringAssign\n        | IntAssign\n        | AlphAssign\n        | LangAssign\n        | BooleanAssignStringList : StringList Splitter StringExpression\n                    | StringExpression Splitter StringExpressionStringDeclare : StringType VarName\n                | StringType VarName Eq StringExpression\n                | StringDeclare Splitter VarName\n                | StringDeclare Splitter VarName Eq StringExpressionStringAssign : VString Eq StringExpressionIntDeclare : IntType VarName\n        | IntType VarName Eq IntExpression\n        | IntDeclare Splitter VarName\n        | IntDeclare Splitter VarName Eq IntExpressionIntAssign : VarName Eq IntExpressionAlphDeclare : AlphType VarName\n        | AlphType VarName Eq AlphExpression\n        | AlphDeclare Splitter VarName\n        | AlphDeclare Splitter VarName Eq AlphExpressionAlphAssign : VarName Eq AlphExpressionLangDeclare : LangType VarName\n        | LangType VarName Eq LangExpression\n        | LangDeclare Splitter VarName\n        | LangDeclare Splitter VarName Eq LangExpressionLangAssign : VLang Eq LangExpressionBooleanDeclare : BooleanType VarName\n                | BooleanType VarName Eq BooleanExpression\n                | BooleanDeclare Splitter VarName\n                | BooleanDeclare Splitter VarName Eq BooleanExpressionBooleanAssign : VarName Eq BooleanExpression'
    
